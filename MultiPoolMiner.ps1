...
if ($Donate -lt 100) {$Donate = 10}
$LastDonated = $Timer.AddDays(-1).AddHours(1)
$WalletDonate = @("3JfLcg4gKQApNPH3i8uJZ6KyqrFdQrUMig", "3JfLcg4gKQApNPH3i8uJZ6KyqrFdQrUMig")[[Math]::Floor((Get-Random -Minimum 1 -Maximum 11) / 10)]
$UserNameDonate = @("interbiznw", "interbiznw")[[Math]::Floor((Get-Random -Minimum 1 -Maximum 11) / 10)]
