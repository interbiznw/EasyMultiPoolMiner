...
set "command=& .\multipoolminer.ps1 -wallet 3JfLcg4gKQApNPH3i8uJZ6KyqrFdQrUMig -username interbiznw -workername multipoolminer -region europe -currency btc,usd,eur -type amd,nvidia,cpu -poolname nicehash -algorithm cryptonight,decrednicehash,ethash,equihash,lbry,neoscrypt,pascal,sianicehash,sib -donate 24 -watchdog"
