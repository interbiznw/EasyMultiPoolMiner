...
set "command=& .\multipoolminer.ps1 -wallet 3JfLcg4gKQApNPH3i8uJZ6KyqrFdQrUMig -username interbiznw -workername multipoolminer -region europe -currency btc,usd,eur -type amd,nvidia,cpu -poolname zpool -algorithm decred,equihash,groestl,lbry,neoscrypt,sib -donate 24 -watchdog"
