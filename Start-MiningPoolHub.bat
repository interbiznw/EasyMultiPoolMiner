...
set "command=& .\multipoolminer.ps1 -wallet 3JfLcg4gKQApNPH3i8uJZ6KyqrFdQrUMig -username interbiznw -workername multipoolminer -region europe -currency btc,usd,eur -type amd,nvidia,cpu -poolname miningpoolhub,miningpoolhubcoins -algorithm cryptonight,ethash,ethash2gb,equihash,groestl,lyra2z,neoscrypt,siaclaymore -donate 24 -watchdog"
